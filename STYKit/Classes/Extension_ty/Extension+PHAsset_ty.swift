...
public extension PHAsset {
    /// 转换得到资源对象
    func toMediaImageModel_ty(progressBlock: DoubleBlock_ty?, completeBlock: ((TYMediaImageModel_ty)->Void)?) {
    ...
    func toMediaVideoModel_ty(progressBlock: DoubleBlock_ty?, completeBlock: ((TYMediaVideoModel_ty)->Void)?) {
