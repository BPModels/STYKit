...
public enum TYAuthorizationType: String {
    /// 相册
    case photo_ty        = "相册"
    /// 照相机
    case camera_ty       = "照相机"
...
@objc
public class TYAuthorizationManager: NSObject, CLLocationManagerDelegate {
    
    @objc
    public static let share_ty = TYAuthorizationManager()
    ...
    // TODO: ==== Tools ====
    private func showAlert_ty(type: TYAuthorizationType) {
        ...
        TYAlertManager.share_ty.twoButton_ty(title: title, description: description, leftBtnName: "取消", leftBtnClosure: nil, rightBtnName: "打开") {
