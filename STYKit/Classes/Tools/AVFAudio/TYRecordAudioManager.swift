...
@objc(TYRecordAudioManagerDelegate)
...
/// 声音管理器
@objc(BPAudioManager)
open class TYRecordAudioManager: NSObject, AVAudioRecorderDelegate {

    @objc
    static public let share_ty = TYRecordAudioManager()
    @objc
