...
public protocol TYPhotoAlbumToolsDelegate: NSObjectProtocol {
    func clickShareAction_ty()
    func clickSaveAction_ty()
    func clickDeleteAction_ty()
}

class TYPhotoAlbumToolsView: TYView {

    weak var delegate_ty: TYPhotoAlbumToolsDelegate?

    private var shareButton_ty: TYButton = {
        let button = TYButton()
    ...
    private var saveButton_ty: TYButton = {
        let button = TYButton()
    ...
    private var deleteButton_ty: TYButton = {
        let button = TYButton()
