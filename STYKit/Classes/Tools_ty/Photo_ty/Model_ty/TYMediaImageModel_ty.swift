...
/// 图片资源
public class TYMediaImageModel_ty: TYMediaModel_ty {
    
    /// 图片压缩格式
    public enum TYImageCompressFormat_ty: Int {
        case jpeg_ty
        case png_ty
    }
    ...
    /// 压缩格式
    public var compressFormat_ty: TYImageCompressFormat_ty?
    /// 原始Data
